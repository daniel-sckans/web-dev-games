...
const socket_init = () => {
    const socket = new WebSocket(!forceBackendUrl && window.location.hostname === 'localhost' ? 'ws://localhost:8080/versus_hex' : 'wss://future-app-location'); 

    socket.addEventListener('open', () => {
        console.log('I think socket works.'); 
    }); 
}; 